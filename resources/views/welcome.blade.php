...
<div class="container">
    <div class="jumbotron">
        ...
        <p class="lead">Ein einfacher Knopf ermöglicht Spenden von kleinen Beträgen zu jeder Zeit
    ...
    <div class="row marketing">
        ...
        <div class="col-sm-6">
            ...
            <p>Kleine Spenden funktionieren mit LittleBits CloudBit oder Amazon Dash. Die Software ist kostenlos und Open Sourc
        </div>
    </div>
</div>
@endsection
